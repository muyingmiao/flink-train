...
//        outerJoinFunction(env);
    ...
    public static void outerJoinFunction(ExecutionEnvironment env) throws Exception {
        ...
        info1.add(new Tuple2<Integer, String>(1,"AAA"));
        info1.add(new Tuple2<Integer, String>(2,"BBB"));
        info1.add(new Tuple2<Integer, String>(3,"CCC"));
        info1.add(new Tuple2<Integer, String>(4,"DDD"));

        List<Tuple2<Integer, String>> info2 = new ArrayList<Tuple2<Integer, String>>();
        info2.add(new Tuple2<Integer, String>(1,"北京"));
        info2.add(new Tuple2<Integer, String>(2,"上海"));
        info2.add(new Tuple2<Integer, String>(3,"杭州"));
        info2.add(new Tuple2<Integer, String>(5,"深圳"));
